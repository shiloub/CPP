...
ShrubberyCreationForm::ShrubberyCreationForm() : Form("Shrubbery_creation", 145, 137), _target("random"){}

ShrubberyCreationForm::ShrubberyCreationForm(std::string target) : Form("Shrubbery_creation", 145, 137), _target(target){}
